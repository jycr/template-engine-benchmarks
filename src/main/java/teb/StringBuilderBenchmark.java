...
public class StringBuilderBenchmark extends BaseBenchmark {
	@Override
	...
	public void run() {
		...
		if ("stocks.stringbuilder.html".equals(templateName)) {
			try {
				IOUtils.write(renderStock(), getOutput());
	...
	public String renderStock() {
		...
		final java.lang.StringBuilder sb = new java.lang.StringBuilder(1024); // or new StringBuilder(8000)
		sb.append(""
		...
		for (final Stock item : items) {
			final String klass = (++i % 2) == 1 ? "odd" : "even";
			sb.append(""
					+ "    <tr class=\"");
			sb.append(klass);
			sb.append("\">\n"
